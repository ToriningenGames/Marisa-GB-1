...
;Which one first?
    ;Control is probably the most important. Also not that difficult.
        ;Done
        ;Implement collisions
    ;Sound effects will be needed
        ;Done. Variable length is nontrivial, though
    ;Tasks need to be beefed up. Specifically, inter-task comms.
        ;Done. I think...
    ;Menu is also essential to getting a game as fast as possible.
    ;I want AI!
        ;Implement collisions, visibility
    ;Environment needs completion (exits, priority, window hiding)
    ;Text would be really fun, because then I can stuff words in people's mouths
        ;TODO: pause
    ;More art needs to be finished
        ;Just the endings now...
    ;I need to flesh out the story a bit more
        ;Check
    ;We can make maps, but what will the forest look like?
        ;Mark I map on paper
    ;Cutscenes?
